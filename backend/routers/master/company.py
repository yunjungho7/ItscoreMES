...
def get_companies(search: Optional[str] = None, company_type: Optional[str] = None, is_customer: Optional[int] = None, page: int = 1, size: int = 50):
    return company_service.get_all(search=search, company_type=company_type, is_customer=is_customer, page=page, size=size)
