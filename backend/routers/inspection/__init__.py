...
@router.get("/inspection/items", summary="검사항목 목록 조회")
...
@router.post("/inspection/items", summary="검사항목 저장 (신규/수정)")
...
@router.get("/inspection/standard", summary="기준서 마스터 목록 조회")
...
@router.get("/inspection/standard/{part_no}/history", summary="기준서 개정 이력 조회")
...
@router.get("/inspection/standard/detail/{code}", summary="기준서 단건(마스터+디테일) 조회")
def get_inspection_standard_detail(code: str):
    return insp_standard_service.get_details(code)

@router.post("/inspection/standard", summary="기준서 일괄 저장 (Master+Detail)")
...
@router.get("/inspection/testscore", summary="검사성적서 마스터 목록 조회")
...
@router.get("/inspection/testscore/{pcode}/details", summary="검사성적서 상세 (기준서 항목) 조회")
