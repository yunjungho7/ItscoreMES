<template>
  <FormModal :visible="visible" title="품목 선택" icon="📦" width="800px" @close="$emit('close')" :showSave="false">
    <div class="picker-content">
      <div class="picker-search">
        <input type="text" v-model="searchText" placeholder="품번 또는 품명 입력" @keyup.enter="fetchData" />
...
const columns = [
  ...
  { key: 'PARTNM', label: '품명', width: '200px' },
  { key: 'STANDARD', label: '규격', width: '150px' },
  { key: 'UNIT', label: '단위', width: '80px' },
  { key: 'PARTTYPE_NM', label: '구분', width: '100px' },
];
