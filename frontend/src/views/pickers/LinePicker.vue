<template>
  <FormModal :visible="visible" title="라인 선택" icon="🏭" width="600px" @close="$emit('close')" :showSave="false">
    <div class="picker-content">
      <div class="picker-search">
        <input type="text" v-model="searchText" placeholder="라인코드 또는 라인명 입력" @keyup.enter="fetchData" />
...
const columns = [
  { key: 'LINECD', label: '라인코드', width: '120px' },
  { key: 'LINENM', label: '라인명', width: '200px' },
  { key: 'FACTORYCD', label: '공장코드', width: '100px' },
];
