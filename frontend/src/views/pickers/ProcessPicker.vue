<template>
  <FormModal :visible="visible" title="공정 선택" icon="⚙️" width="600px" @close="$emit('close')" :showSave="false">
    <div class="picker-content">
      <div class="picker-search">
        <input type="text" v-model="searchText" placeholder="공정코드 또는 공정명 입력" @keyup.enter="fetchData" />
...
const columns = [
  ...
  { key: 'PROCESSNM', label: '공정명', width: '200px' },
